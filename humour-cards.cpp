...
Card::Card (std::string n, std::string t, int m, std::string y, std::string d): name(n), type(t), number(m), symbol(y), describe(d)
{}

void card_text_display(Card n)
{
  std::cout << "\n==============================\n";
...
Card error_card ("Error Card", "None", 0, "Error", "This card should only come up if there is an\n   error. Check stdout for details.");
...
Card draw_card(int x)
{
switch (x)
  {
 case 1:
return knight_of_blood;
break;
 case 2:
return jester_of_hearts;
break;
 case 3:
return esper_of_air;
break;
 case 4:
return hopeful_vagabond;
break;
 case 5:
return playful_child;
break;
 case 6:
return witch_of_spring;
break;
 case 7:
return cleric_of_courage;
break;
 case 8:
return carefree_musician;
break;
 case 9:
return rainforest_guardian;
break;
 case 10:
return sanguine_scholar;
break;
 case 11:
return knight_of_gall;
break;
 case 12:
return jester_of_livers;
break;
 case 13:
return esper_of_fire;
break;
 case 14:
return restless_vagabond;
break;
 case 15:
return ambitious_child;
break;
 case 16:
return witch_of_summer;
break;
 case 17:
return cleric_of_leadership;
break;
 case 18:
return angry_musician;
break;
 case 19:
return desert_guardian;
break;
 case 20:
return choleric_scholar;
break;
 case 21:
return knight_of_tears;
break;
 case 22:
return jester_of_spleens;
break;
 case 23:
return esper_of_earth;
break;
 case 24:
return despondent_vagabond;
break;
 case 25:
return quiet_child;
break;
 case 26:
return witch_of_autumn;
break;
 case 27:
return cleric_of_analysis;
break;
 case 28:
return serious_musician;
break;
 case 29:
return tundra_guardian;
break;
 case 30:
return melancholic_scholar;
break;
 case 31:
return knight_of_plague;
break;
 case 32:
return jester_of_brains;
break;
 case 33:
return esper_of_water;
break;
 case 34:
return peaceful_vagabond;
break;
 case 35:
return thoughtful_child;
break;
 case 36:
return witch_of_winter;
break;
 case 37:
return cleric_of_patience;
break;
 case 38:
return calm_musician;
break;
 case 39:
return taiga_guardian;
break;
 case 40:
return phlegmatic_scholar;
break;
 default:
std::cout << "Error: Non-card Result!\n";
return error_card;
break;
}
