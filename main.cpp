...
int main(int argc, char** argv)
{
  ...
  switch (x)
    ...
    case 1:
      ...
      break;
    case 2:
      display(jester_of_hearts);
      break;
    case 3:
      display(esper_of_air);
      break;
    case 4:
      display(hopeful_vagabond);
      break;
    case 5:
      display(playful_child);
      break;
    case 6:
      display(witch_of_spring);
      break;
    case 7:
      display(cleric_of_courage);
      break;
    case 8:
      display(carefree_musician);
      break;
    case 9:
      display(rainforest_guardian);
      break;
    case 10:
      display(sanguine_scholar);
      break;
    case 11:
      display(knight_of_gall);
      break;
    case 12:
      display(jester_of_livers);
      break;
    case 13:
      display(esper_of_fire);
      break;
    case 14:
      display(restless_vagabond);
      break;
    case 15:
      display(ambitious_child);
      break;
    case 16:
      display(witch_of_summer);
      break;
    case 17:
      display(cleric_of_leadership);
      break;
    case 18:
      display(angry_musician);
      break;
    case 19:
      display(desert_guardian);
      break;
    case 20:
      display(choleric_scholar);
      break;
    case 21:
      display(knight_of_tears);
      break;
    case 22:
      display(jester_of_spleens);
      break;
    case 23:
      display(esper_of_earth);
      break;
    case 24:
      display(despondent_vagabond);
      break;
    case 25:
      display(quiet_child);
      break;
    case 26:
      display(witch_of_autumn);
      break;
    case 27:
      display(cleric_of_analysis);
      break;
    case 28:
      display(serious_musician);
      break;
    case 29:
      display(tundra_guardian);
      break;
    case 30:
      display(melancholic_scholar);
      break;
    case 31:
      display(knight_of_plague);
      break;
    case 32:
      display(jester_of_brains);
      break;
    case 33:
      display(esper_of_water);
      break;
    case 34:
      display(peaceful_vagabond);
      break;
    case 35:
      display(thoughtful_child);
      break;
    case 36:
      display(witch_of_winter);
      break;
    case 37:
      display(cleric_of_patience);
      break;
    case 38:
      display(calm_musician);
      break;
    case 39:
      display(taiga_guardian);
      break;
    case 40:
      display(phlegmatic_scholar);
      break;
    default:
